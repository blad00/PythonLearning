...
out_file = "/mnt/WORKSPACE/dcr_workspace/Projects/QC_reseq/Testing1sample/104197_holi.tsv"

# trim_VCF(in_file, out_file, 1000)
random_sample_selection(in_file,out_file,50)
