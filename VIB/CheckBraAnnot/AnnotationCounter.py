...
with open("D:\DanielVIB\Brassica\Annotation2020TRAPID\Results\BrassicaNapusAnnotExomePlaza4.5.txt", "r") as file1,\
		open("D:\DanielVIB\Brassica\Annotation2020TRAPID\Results\BrassicaNapusAnnotExomePlaza4.5COUNTS.tsv", "w") as outfile:
	next(file1)
